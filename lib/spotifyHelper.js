...
export let FRONTEND_URI = 'https://spotify-dashboard-bay.vercel.app/'
// export let REDIRECT_URI = process.env.REDIRECT_URI || 'http://localhost:3000/api/callback/';
// export let FRONTEND_URI = process.env.FRONTEND_URI || 'http://localhost:3000';
...
export const LOGIN_URI = process.env.LOGIN_URI ||'http://localhost:3000/api/login'
// TOKENS ******************************************************************************************
