      ...
      <div className="flex flex-col max-w-min md:mx-auto">
        ...
        <div className="space-y-3">
          <div className="flex space-x-3 items-center">
            <Link href={`/artist/?id=${props.topArtistsShort.items[0].id}`}>
              <div
                style={{
            ...
            <Link href={`/artist/?id=${props.topArtistsShort.items[1].id}`}>
              <div
                style={{
          ...
          <div className="flex space-x-3 items-center">
            <Link href={`/artist/?id=${props.topArtistsShort.items[2].id}`}>
              <div
                style={{
            ...
            <Link href={`/artist/?id=${props.topArtistsShort.items[3].id}`}>
              <div
                style={{
